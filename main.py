...
if __name__ == '__main__':
    ...
    parser.add_argument('--get', dest='query', choices=['weather_demo', 'realtime', 'forecast', 'town', 'towns', 'stations'], default='realtime')
    ...
    parser.add_argument('--max_distance', type=str)
    ...
    if args.id:
        ...
        if args.max_distance:
            print getattr(w, 'get_' + args.query)(float(coordinates['data']['lat']), float(coordinates['data']['lng']), float(args.max_distance))
        else:
